...
//                        echo '<div class="col-md-1" style="margin-bottom: 30px; margin-right: 10px;"> <div class="dropup">';
//                        echo '<button class="btn btn-custom ferozaButton" type="button" id="about-us" data-target="#myModal1"  data-toggle="modal">'.strval(((int)($rangeYear[0]->MN))+$i*10).'-'.strval((((int)($rangeYear[0]->MN))+$i*10)+9).'</button>';   
//                        echo '</div></div>';
//                    }
//                    else{
//                        echo '<div class="col-md-1" style="margin-bottom: 30px; margin-right: 10px;"> <div class="dropup">';
                                    ...
                                    <div class="modal fade" id="myModal1" role="dialog">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                    <h4 class="modal-title" style="text-align: center">Rabindra Sangeet</h4>
    ...
    $(document).ready(function () {
        ...
        $(".ferozaButton").click(function () {
            ...
            $.ajax({
                ...
                type: "get",
                data: {songListID: songListID, songID: 2},
                cache: false,
                success: function (data) {
                    console.log(data);
