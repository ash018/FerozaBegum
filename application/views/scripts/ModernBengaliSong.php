    ...
    <div class="container"> 
        <div class="row">
            <div class="programmeheader col-md-12">
                <h4>Feroza Begum Modern Bengali Song</h4>
            </div>
        </div>
    </div>
        ...
        <div class = "row">
            ...
            while($i<sizeof($results)){
                ...
                echo '<div class = "col-md-4">'
                       .'<h6 class="lyricBox">'
                       .$results[$i]->ModernBengaliSongLyrics.'<br>'.'Published Year: '.$results[$i]->Year
                       .'</h6>'
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Modern Bengali Song Book</h4>
