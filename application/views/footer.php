...
<div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <img src="<?php echo base_url()?>asset/img/f.jpg>" class="img-responsive" alt="Facebook">
            ...
            <div class="row">
                <div class="col-5 col-md-2 f_margin_right_10">
                    <div class="dropup" >
                        ...
                        <div class="dropdown-menu f_dropdown-menu-left" style=" background-color: #fff;">
                            ...
                            <div style="border: 0px solid;  margin-top: 50px; margin-bottom: 20px;">
                                <form style="padding: 0 15px;">
                                    <div class="form-group" style="margin-bottom: 0rem;">
                                        <input type="text" name="SubscribeName" id="SubscribeName" class="form-control" placeholder="Enter Name">
                                    </div>
